...
public static class KeyMap
{
    ...
    public static KeyGroup[] Wall(bool splitting) => With(
        ...
        new KeyGroup("Layout",
            ...
            splitting
                ...
                : new KeyHint("v / s", "Split this pane, right / down"),
            new KeyHint("alt+\\ / alt+-", "Same, from inside a pane"),
            new KeyHint("alt+, / alt+.", "Move a pane between tiles"),
            new KeyHint("alt+/", "Move it out into its own tile"),
    ...
    public static KeyGroup[] Terminal() => With(
        new KeyGroup("This pane",
            ...
            Bound(KeyAction.SplitHere, "Split this pane, side by side"),
            Bound(KeyAction.SplitHereDown, "Split this pane, one above the other"),
            Bound(KeyAction.PaneToNext, "Move it into the next tile"),
            Bound(KeyAction.PaneOut, "Move it out into its own tile"),
    ...
    public static KeyGroup[] Released() => With(
        ...
        new KeyGroup("The wall",
            ...
            new KeyHint("t", "New terminal"),
            Bound(KeyAction.SplitHere, "Split this pane, side by side"),
            Bound(KeyAction.SplitHereDown, "Split it the other way")),
        new KeyGroup("Arranging",
            new KeyHint("alt+, / alt+.", "Move this pane into the tile before / after"),
            Bound(KeyAction.PaneOut, "Move it out into a tile of its own"),
            new KeyHint("^⇧←→↑↓", "Move this pane"),
            new KeyHint("alt+⇧←→↑↓", "Resize"),
            new KeyHint("drag a tile", "Move it onto another")),
        new KeyGroup("Leaving",
