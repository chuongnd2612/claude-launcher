...
| Terminals (the mouse) | click a tile to focus it and type into it · **triple-click a tile to close it** (a pinned tile refuses) · drag a tile onto another to move it · drag a gutter or an interior divider to resize · the wheel scrolls whatever is under the pointer · clicking off the tiles hands the keyboard back |
